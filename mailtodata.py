...
class mailtodata: 
    ...
    def __init__(self):
        ...
        self.filename_hash = "emaildata_hash.json"

        # Generate the Loookup File for Hashes : Email Addresses
        self.json_data = mailto.mailto.ReadJSONfile(self, self.filename) 
        ...
        self.WriteDatatoFile(self.email_address_hashed, "emaildata_lookup.json")
        ...
        for email_group, email_list in email_data.items(): 
            ...
            for email in email_list: 
                ...
                if len(match) > 0: 
                    ...
                    new_email_data[email_group] = email_hash_list
